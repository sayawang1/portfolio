...
with nav_col1:
    # 当前在 Demo 页面，所以 Demo 按钮高亮（type="primary"）
    if st.button("🧪 推荐系统 Demo", use_container_width=True, type="primary"):
        pass # 当前页面，无需跳转

with nav_col2:
    if st.button("⚙️ 推荐系统运营后台", use_container_width=True):
        st.switch_page("pages/2_推荐系统运营后台.py")

# ==========================================
# 下面是你原本页面的代码（不要动，直接接在下面）
# 比如你之前的 st.title("📈 推荐系统·选品 & 效果预览") 等逻辑
# ==========================================
